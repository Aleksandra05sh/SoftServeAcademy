...
class FrontendDev {
  protected frondendTechnology: string [];
  constructor(frondendTechnology: string []) {
    this.frondendTechnology = frondendTechnology;
  }
}
  
class FullStackDeveloper extends FrontendDev {
  protected _backendTechnology: string [];
  constructor(frondendTechnology: string [], backendTechnology: string []) {
    super(frondendTechnology);
    this._backendTechnology = backendTechnology;
  }

  get backendTechnology(): string[] {
...
const mike: FrontendDev = new FullStackDeveloper(['HTML', 'JS'], ['NodeJS']);  
console.log(mike);
